...
var item_create_component_1 = require('./item-create.component');
var ItemListComponent = (function () {
    ...
    ItemListComponent = __decorate([
        core_1.Component({
            selector: 'item',
            templateUrl: 'app/items/item-list.component.html',
            styleUrls: ['app/items/item-list.component.css'],
            pipes: [item_filter_pipe_1.ItemFilterPipe],
            directives: [star_component_1.StarComponent, item_create_component_1.ItemCreateComponent],
