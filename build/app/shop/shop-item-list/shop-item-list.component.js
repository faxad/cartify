...
var ShopItemListComponent = (function () {
    ...
    ShopItemListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.customerId = index_1.AuthService.getUser();
    ...
    ShopItemListComponent = __decorate([
        core_1.Component({
            ...
            providers: [index_1.ShopService, index_1.CartService]
        }), 
        __metadata('design:paramtypes', [index_1.ShopService, index_1.AuthService, index_1.CartService])
